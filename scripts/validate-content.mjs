...
const requiredPillars = [
  ...
  "Connection risk",
  "Recovery action",
  "Not digital signage. Passenger decision intelligence",
  "Any vendor can display signs",
  "next correct passenger instruction",
  "Screens publish the message",
  "SmartSEA decides the right message",
  "The SmartSEA role",
  "Invitation to engage",
  "Baggage status",
  "MCT and recovery",
  "Flight + baggage + rail + cruise departure are treated as one journey",
  "PPA Cruise Operations Live",
  "PPA Mobility Desk",
  "PPA transfer Bay 3",
  "PPA baggage hall",
  "PPA screens publish the message",
  "format-panel",
  "format: \"advisory\"",
  "format: \"baggage\"",
  "format: \"staff\"",
